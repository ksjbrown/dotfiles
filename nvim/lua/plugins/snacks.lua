local cfg = { cwd = vim.fn.stdpath("config"), title = "Config" }
return {
    "folke/snacks.nvim",
    lazy = false,
    priority = 1000,
    keys = {
        ...
        { "<leader>fc",      function() require("snacks").picker.files(cfg) end,              desc = "Config" },
        { "<leader>fC",      function() require("snacks").explorer(cfg) end,                  desc = "Config" },
